...
class App : Application() {
  ...
  override fun onCreate() {
    ...
    // Initialize default application language (Simplified Chinese zh-CN by default on first launch)
    runCatching {
      val appearancePreferences: AppearancePreferences = getKoin().get()
      val lang = appearancePreferences.appLanguage.get()
      if (lang.isBlank()) {
        appearancePreferences.appLanguage.set("zh-CN")
