...
class AiPreferences(
  ...
  val provider = preferenceStore.getEnum("ai_provider", AiProvider.CUSTOM)
  ...
  private val customSelectedModel = preferenceStore.getString("ai_selected_model_custom", "")
  ...
  private val customAvailableModels = preferenceStore.getString("ai_available_models_custom", "[]")
  ...
  val bilingualSubtitlesEnabled = preferenceStore.getBoolean("ai_bilingual_subtitles_enabled", true)
  ...
  fun selectedModelFor(provider: AiProvider): Preference<String> = when (provider) {
    AiProvider.CUSTOM -> customSelectedModel
  ...
  fun availableModelsFor(provider: AiProvider): Preference<String> = when (provider) {
    AiProvider.CUSTOM -> customAvailableModels
