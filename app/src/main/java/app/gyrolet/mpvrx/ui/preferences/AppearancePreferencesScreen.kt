        ...
        Scaffold(
            ...
            ProvidePreferenceLocals {
                LazyColumn(
                    ...
                    item {
                        PreferenceSectionHeader(title = stringResource(id = R.string.pref_app_language_title))
                    }

                    item {
                        val appLanguage by preferences.appLanguage.collectAsState()
                        val currentLang = if (appLanguage.isBlank()) "zh-CN" else appLanguage
                        val languageOptions = listOf("zh-CN", "system", "en")
                        PreferenceCard {
                            ListPreference(
                                value = currentLang,
                                onValueChange = { selected ->
                                    preferences.appLanguage.set(selected)
                                    if (selected == "system") {
                                ...
                                valueToText = { lang ->
                                    AnnotatedString(
                                        when (lang) {
                                            "zh-CN" -> stringResource(R.string.pref_language_zh_cn)
                                            "system" -> stringResource(R.string.pref_language_system)
                                            "en" -> stringResource(R.string.pref_language_en)
                                            else -> lang
                                        }
                                    )
                                },
