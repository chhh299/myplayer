...
val domainModule = module {
    ...
    single<AiClient>(named("custom")) {
        val aiPreferences: AiPreferences = get()
        app.gyrolet.mpvrx.repository.ai.CustomAiClient(get(), get(), baseUrlProvider = { aiPreferences.customBaseUrl.get() })
    }
